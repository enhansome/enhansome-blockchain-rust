...
* [Fuel](https://github.com/FuelLabs/fuel-core) ⭐ 56,902 | 🐛 200 | 🌐 Rust | 📅 2026-08-16.
  Rust full node implementation of the Fuel protocol.
* [Libra](https://github.com/libra/libra) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-14.
...
* [Sui Network](https://github.com/MystenLabs/sui) ⭐ 7,736 | 🐛 811 | 🌐 Rust | 📅 2026-08-18.
...
* [Grin](https://github.com/mimblewimble/grin) ⭐ 5,093 | 🐛 138 | 🌐 Rust | 📅 2026-08-11.
  Minimal implementation of the MimbleWimble protocol.
* [Lighthouse](https://github.com/sigp/lighthouse) ⭐ 3,467 | 🐛 519 | 🌐 Rust | 📅 2026-08-18.
  Fast and secure Ethereum 2.0 client.
* [Stacks 2.0](https://github.com/blockstack/stacks-blockchain) ⭐ 3,061 | 🐛 680 | 🌐 Rust | 📅 2026-08-17.
  Proof of Transfer blockchain from Blockstack.
* [NEAR](https://github.com/nearprotocol/nearcore) ⭐ 2,609 | 🐛 494 | 🌐 Rust | 📅 2026-08-18.
...
* [NYM](https://github.com/nymtech/nym) ⭐ 1,903 | 🐛 130 | 🌐 Rust | 📅 2026-08-18.
  Selective privacy via a mixnet preventing metadata analysis.
* [Internet Computer Protocol (ICP)](https://github.com/dfinity/ic) ⭐ 1,784 | 🐛 260 | 🌐 Rust | 📅 2026-08-18.
...
* [Holochain](https://github.com/holochain/holochain) ⭐ 1,390 | 🐛 267 | 🌐 Rust | 📅 2026-08-17.
...
* [Exonum](https://github.com/exonum/exonum) ⭐ 1,244 | 🐛 44 | 🌐 Rust | 📅 2024-02-25.
  An extensible open-source framework for creating
  private/permissioned blockchain applications.
* [Nervos CKB](https://github.com/nervosnetwork/ckb) ⭐ 1,219 | 🐛 71 | 🌐 Rust | 📅 2026-08-11.
  Nervos CKB is a public permissionless blockchain, the common
  knowledge layer of Nervos network.
* [Ethrex](https://github.com/lambdaclass/ethrex) ⭐ 888 | 🐛 991 | 🌐 Rust | 📅 2026-08-14.
...
* [Conflux](https://github.com/Conflux-Chain/conflux-rust) ⭐ 719 | 🐛 72 | 🌐 Rust | 📅 2026-08-12.
  The Rust implementation of Conflux protocol.
* [Forest](https://github.com/ChainSafe/forest) ⭐ 696 | 🐛 124 | 🌐 Rust | 📅 2026-08-18.
...
* [Zebra](https://github.com/ZcashFoundation/zebra) ⭐ 596 | 🐛 384 | 🌐 Rust | 📅 2026-08-18.
  An ongoing Rust implementation of a Zcash node.
* [Radix](https://github.com/radixdlt/radixdlt-scrypto) ⭐ 410 | 🐛 25 | 🌐 Rust | 📅 2026-03-27.
  Sharded smart contract DeFi platform.
* [Casper](https://github.com/casper-network/casper-node) ⭐ 401 | 🐛 195 | 🌐 Rust | 📅 2026-07-24.
  A decentralized L1 PoS blockchain designed to accelerate enterprise and developer adoption.
* [Gear](https://github.com/gear-tech/gear) ⭐ 264 | 🐛 118 | 🌐 Rust | 📅 2026-08-18.
  Computational component of Polkadot network.
* [Zero-chain](https://github.com/LayerXcom/zero-chain) ⭐ 262 | 🐛 59 | 🌐 Rust | 📅 2025-02-03.
  A privacy-preserving blockchain on Substrate.
* [CodeChain](https://github.com/CodeChain-io/codechain) ⭐ 256 | 🐛 64 | 🌐 Rust | 📅 2023-01-07.
  Programmable multi-asset chain.
* [Darwinia](https://github.com/darwinia-network/darwinia) ⭐ 245 | 🐛 29 | 🌐 Rust | 📅 2026-07-30.
...
* [Shasper](https://github.com/paritytech/shasper) ⚠️ Archived.
  ...
  framework.
* [Witnet](https://github.com/witnet/witnet-rust) ⭐ 187 | 🐛 128 | 🌐 Rust | 📅 2026-05-19.
...
* [Polymesh](https://github.com/PolymathNetwork/Polymesh) ⭐ 170 | 🐛 4 | 🌐 Rust | 📅 2026-08-17.
...
* [Enigma](https://github.com/enigmampc/enigma-core) ⚠️ Archived secures the
  decentralized web.
* [Chainflip](https://github.com/chainflip-io/chainflip-backend/) ⭐ 69 | 🐛 47 | 🌐 Rust | 📅 2026-08-18.
...
* [Anchor](https://github.com/coral-xyz/anchor) ⭐ 5,112 | 🐛 159 | 🌐 Rust | 📅 2026-08-17
...
* [Trident](https://github.com/Ackee-Blockchain/trident) ⭐ 400 | 🐛 19 | 🌐 Rust | 📅 2026-05-18.
...
* [Hermes](https://github.com/informalsystems/hermes) ⭐ 505 | 🐛 220 | 🌐 Rust | 📅 2025-10-29.
...
* [AtomicDEX](https://github.com/KomodoPlatform/atomicDEX-API) ⭐ 125 | 🐛 416 | 🌐 Rust | 📅 2026-07-27.
  Cross-chain and cross-protocol p2p orderbook based decentralized exchange and interoperability bridge (self-custodial).
* [Hyperlane](https://github.com/hyperlane-xyz/hyperlane-monorepo) ⭐ 72 | 🐛 910 | 🌐 TypeScript | 📅 2026-08-18.
...
* [Wasmer](https://github.com/wasmerio/wasmer) ⭐ 20,957 | 🐛 237 | 🌐 Rust | 📅 2026-08-18.
  A convenient Rust wrapper over WebAssembly backends.
* [Wasmtime](https://github.com/CraneStation/wasmtime) ⭐ 18,534 | 🐛 845 | 🌐 Rust | 📅 2026-08-14.
...
* [Lunatic](https://github.com/lunatic-solutions/lunatic) ⭐ 4,882 | 🐛 48 | 🌐 Rust | 📅 2025-03-29.
  Erlang-inspired runtime for WebAssembly.
* [Wasmi](https://github.com/paritytech/wasmi) ⭐ 2,168 | 🐛 24 | 🌐 Rust | 📅 2026-08-11.
  WebAssembly interpreter.
* [CosmWasm](https://github.com/CosmWasm/cosmwasm) ⭐ 1,146 | 🐛 43 | 🌐 Rust | 📅 2026-08-17.
  Multi-chain smart contract platform built for the Cosmos ecosystem.
* [Polygon Miden](https://github.com/maticnetwork/miden) ⭐ 768 | 🐛 211 | 🌐 Rust | 📅 2026-08-18.
  SNARK based VM.
* [CKB-VM](https://github.com/nervosnetwork/ckb-vm) ⭐ 422 | 🐛 13 | 🌐 Rust | 📅 2026-08-13.
  RISC-V virtual machine.
* [FVM](https://github.com/filecoin-project/ref-fvm) ⭐ 421 | 🐛 194 | 🌐 Rust | 📅 2026-08-13.
...
* [FuelVM](https://github.com/FuelLabs/fuel-vm) ⭐ 372 | 🐛 44 | 🌐 Rust | 📅 2026-07-17.
...
* [Raft](https://github.com/pingcap/raft-rs) ⭐ 3,376 | 🐛 78 | 🌐 Rust | 📅 2026-05-13.
...
* [rust-libp2p](https://github.com/libp2p/rust-libp2p) ⭐ 5,600 | 🐛 289 | 🌐 Rust | 📅 2026-08-17.
...
* [Tentacle](https://github.com/driftluo/tentacle) ⭐ 227 | 🐛 1 | 🌐 Rust | 📅 2026-07-28.
...
* [Microsoft Nova](https://github.com/microsoft/Nova) ⭐ 861 | 🐛 25 | 🌐 Rust | 📅 2026-08-10.
...
* [Awesome Cryptography Rust](https://github.com/rust-cc/awesome-cryptography-rust) ⭐ 588 | 🐛 3 | 📅 2026-07-01.
...
* [Noir language](https://github.com/noir-lang/noir) ⭐ 1,389 | 🐛 808 | 🌐 Rust | 📅 2026-08-18.
  Noir is a Domain Specific Language for SNARK proving systems. (Aztec eth L2)
* [Rust-Lightning](https://github.com/rust-bitcoin/rust-lightning) ⭐ 1,369 | 🐛 275 | 🌐 Rust | 📅 2026-08-17
...
* [Penumbra](https://github.com/penumbra-zone/penumbra) ⭐ 483 | 🐛 203 | 🌐 Rust | 📅 2026-01-24.
...
* [Serum-dex](https://github.com/project-serum/serum-dex) ⭐ 697 | 🐛 65 | 🌐 Rust | 📅 2024-06-07.
...
* [SewUp](https://github.com/second-state/SewUp) ⭐ 54 | 🐛 40 | 🌐 Rust | 📅 2023-09-11.
...
Rust](https://github.com/rust-in-blockchain/awesome-blockchain-rust) ⭐ 2,805 | 🐛 13 | 📅 2026-05-17
