...
* [Fuel](https://github.com/FuelLabs/fuel-core) ⭐ 56,872 | 🐛 201 | 🌐 Rust | 📅 2026-08-30.
  Rust full node implementation of the Fuel protocol.
* [Libra](https://github.com/libra/libra) ⭐ 16,670 | 🐛 368 | 🌐 Rust | 📅 2026-08-28.
...
* [Sui Network](https://github.com/MystenLabs/sui) ⭐ 7,741 | 🐛 823 | 🌐 Rust | 📅 2026-08-31.
...
* [Lighthouse](https://github.com/sigp/lighthouse) ⭐ 3,466 | 🐛 531 | 🌐 Rust | 📅 2026-08-31.
  Fast and secure Ethereum 2.0 client.
* [Stacks 2.0](https://github.com/blockstack/stacks-blockchain) ⭐ 3,062 | 🐛 686 | 🌐 Rust | 📅 2026-08-31.
  Proof of Transfer blockchain from Blockstack.
* [NEAR](https://github.com/nearprotocol/nearcore) ⭐ 2,613 | 🐛 510 | 🌐 Rust | 📅 2026-08-31.
...
* [NYM](https://github.com/nymtech/nym) ⭐ 1,921 | 🐛 131 | 🌐 Rust | 📅 2026-08-31.
  Selective privacy via a mixnet preventing metadata analysis.
* [Internet Computer Protocol (ICP)](https://github.com/dfinity/ic) ⭐ 1,789 | 🐛 282 | 🌐 Rust | 📅 2026-08-31.
...
* [Holochain](https://github.com/holochain/holochain) ⭐ 1,393 | 🐛 268 | 🌐 Rust | 📅 2026-08-31.
...
* [Nervos CKB](https://github.com/nervosnetwork/ckb) ⭐ 1,219 | 🐛 79 | 🌐 Rust | 📅 2026-08-27.
  Nervos CKB is a public permissionless blockchain, the common
  knowledge layer of Nervos network.
* [Ethrex](https://github.com/lambdaclass/ethrex) ⭐ 889 | 🐛 992 | 🌐 Rust | 📅 2026-08-31.
...
* [Conflux](https://github.com/Conflux-Chain/conflux-rust) ⭐ 718 | 🐛 72 | 🌐 Rust | 📅 2026-08-31.
  The Rust implementation of Conflux protocol.
* [Forest](https://github.com/ChainSafe/forest) ⭐ 696 | 🐛 139 | 🌐 Rust | 📅 2026-08-31.
...
* [Zebra](https://github.com/ZcashFoundation/zebra) ⭐ 601 | 🐛 370 | 🌐 Rust | 📅 2026-08-29.
...
* [Darwinia](https://github.com/darwinia-network/darwinia) ⭐ 245 | 🐛 29 | 🌐 Rust | 📅 2026-08-27.
...
* [Polymesh](https://github.com/PolymathNetwork/Polymesh) ⭐ 170 | 🐛 4 | 🌐 Rust | 📅 2026-08-31.
...
* [Enigma](https://github.com/enigmampc/enigma-core) ⚠️ Archived secures the
  decentralized web.
* [Chainflip](https://github.com/chainflip-io/chainflip-backend/) ⭐ 70 | 🐛 51 | 🌐 Rust | 📅 2026-08-31.
...
* [Anchor](https://github.com/coral-xyz/anchor) ⭐ 5,123 | 🐛 167 | 🌐 Rust | 📅 2026-08-28
...
* [Hyperlane](https://github.com/hyperlane-xyz/hyperlane-monorepo) ⭐ 73 | 🐛 961 | 🌐 TypeScript | 📅 2026-08-31.
...
* [Wasmer](https://github.com/wasmerio/wasmer) ⭐ 20,995 | 🐛 250 | 🌐 Rust | 📅 2026-08-31.
  A convenient Rust wrapper over WebAssembly backends.
* [Wasmtime](https://github.com/CraneStation/wasmtime) ⭐ 18,586 | 🐛 857 | 🌐 Rust | 📅 2026-08-31.
...
* [Lunatic](https://github.com/lunatic-solutions/lunatic) ⭐ 4,885 | 🐛 48 | 🌐 Rust | 📅 2025-03-29.
  Erlang-inspired runtime for WebAssembly.
* [Wasmi](https://github.com/paritytech/wasmi) ⭐ 2,180 | 🐛 25 | 🌐 Rust | 📅 2026-08-28.
...
* [Polygon Miden](https://github.com/maticnetwork/miden) ⭐ 770 | 🐛 184 | 🌐 Rust | 📅 2026-08-31.
  SNARK based VM.
* [CKB-VM](https://github.com/nervosnetwork/ckb-vm) ⭐ 423 | 🐛 13 | 🌐 Rust | 📅 2026-08-21.
  RISC-V virtual machine.
* [FVM](https://github.com/filecoin-project/ref-fvm) ⭐ 423 | 🐛 191 | 🌐 Rust | 📅 2026-08-29.
...
* [rust-libp2p](https://github.com/libp2p/rust-libp2p) ⭐ 5,607 | 🐛 291 | 🌐 Rust | 📅 2026-08-31.
...
* [Microsoft Nova](https://github.com/microsoft/Nova) ⭐ 862 | 🐛 27 | 🌐 Rust | 📅 2026-08-24.
...
* [Awesome Cryptography Rust](https://github.com/rust-cc/awesome-cryptography-rust) ⭐ 588 | 🐛 1 | 📅 2026-07-01.
...
* [zkSync](https://github.com/matter-labs/zksync) ⭐ 4,925 | 🐛 106 | 🌐 Rust | 📅 2026-05-08.
  Matter Labs' scaling eth L2 engine secured by zero-knowledge proofs.
* [Noir language](https://github.com/noir-lang/noir) ⭐ 1,395 | 🐛 797 | 🌐 Rust | 📅 2026-08-31.
  Noir is a Domain Specific Language for SNARK proving systems. (Aztec eth L2)
* [Rust-Lightning](https://github.com/rust-bitcoin/rust-lightning) ⭐ 1,372 | 🐛 275 | 🌐 Rust | 📅 2026-08-31
...
* [SewUp](https://github.com/second-state/SewUp) ⭐ 54 | 🐛 42 | 🌐 Rust | 📅 2023-09-11.
...
Rust](https://github.com/rust-in-blockchain/awesome-blockchain-rust) ⭐ 2,810 | 🐛 13 | 📅 2026-05-17
